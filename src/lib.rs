    ...
    pub fn digest<S: AsRef<str>>(&mut self, text: S) -> Result<(), &'static str> {
        for c in text.as_ref().chars() {
            if is_ascii_control!(c) {
                ...
                } else if self.counter == 1 || self.counter == 2 || self.counter == 5 {
                    if !is_ascii_control!(c) {
                        self.counter = 0;
                    }
                } else {
                ...
                if c == '<' {
                    ...
                    self.is_just_finish_tagging = true;
                } else if self.counter == 1 || self.counter == 2 || self.counter == 10 {
                    if !is_ascii_control!(c) {
                        self.counter = 0;
                    }
                } else {
                ...
                if c == '<' {
                    ...
                    self.is_just_finish_tagging = true;
                } else if self.counter == 1 || self.counter == 2 || self.counter == 8 {
                    if !is_ascii_control!(c) {
                        self.counter = 0;
                    }
                } else {
                ...
                if c == '<' {
                    ...
                    self.is_just_finish_tagging = true;
                } else if self.counter == 1 || self.counter == 2 || self.counter == 7 {
                    if !is_ascii_control!(c) {
                        self.counter = 0;
                    }
                } else {
                ...
                if self.ignoring_space {
                    continue;
                } else if self.in_start_tagging || self.in_end_tagging {
                    self.in_start_tagging = false;
                } else if self.is_tagging {
                    if self.in_attribute {
                        if self.attribute.eq(&"class".to_string()) && self.last_space {
                            continue;
                        }
                ...
                if c == '<' && !self.is_tagging {
                    ...
                    if c == '>' {
                        ...
                        if self.counter > 0 {
                            ...
                            if self.counter == 3 {
                                ...
                                if self.last_space
                                    && !is_space_or_new_line!(*self.out.last().unwrap())
                                {
                    ...
                    if self.is_just_finish_tagging && self.last_space && self.line_space {
                        let end = self.out.len() - 1;
                        self.out.remove(end);
                    }
                    self.ignoring_space = false;
